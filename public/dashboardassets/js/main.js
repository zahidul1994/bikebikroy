$(document).ready(function () {
    ...
    $(".qus-a").click(function () {
        $(".ans-a").slideToggle();
    });
      $(".qus-b").click(function () {
        $(".ans-b").slideToggle();
    });
      $(".qus-c").click(function () {
        $(".ans-c").slideToggle();
    });
      $(".qus-d").click(function () {
        $(".ans-d").slideToggle();
    });
      $(".qus-e").click(function () {
        $(".ans-e").slideToggle();
    });
      $(".qus-f").click(function () {
        $(".ans-f").slideToggle();
    });
      $(".qus-g").click(function () {
        $(".ans-g").slideToggle();
    });
      $(".qus-h").click(function () {
        $(".ans-h").slideToggle();
    });
      $(".qus-i").click(function () {
        $(".ans-i").slideToggle();
    });
      $(".qus-j").click(function () {
        $(".ans-j").slideToggle();
    });

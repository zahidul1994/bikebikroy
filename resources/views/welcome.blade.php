            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="banner-item text-center">
                        ...
                        <form class="d-flex banner-src-form">
                            <input class="form-control banner-src-box" type="search" placeholder="What are you looking for?" aria-label="Search">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="category-tittle mb-0">
                                Browse items by Brands
                            </p>
                        </div>
                        <div class="col-md-6">
                            <p class="category-tittle mb-0 text-end">
                                <a href="#"> See more brand</a>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/yamaha-logo-1.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">

                                            <span>76,116 ads</span>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/suzuki-1.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/bajaj.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/hero.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/honda.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/tvs.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/lifan.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/runner.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                         ...
                         <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2021/03/zontes-motorcycle-comapny-logo.jpg" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/haojue.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/benelli.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/keeway.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                         ...
                         <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/kawasaki.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/ktm.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/aprilia.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="#">
                                    <div class="single-category">
                                        <div class="cat-icon align-self-center">
                                            <img src="https://www.bikebd.com/wp-content/uploads/2020/12/vespa.png" alt="" class="w-100">
                                        </div>
                                        <div class="cat-text align-self-center">

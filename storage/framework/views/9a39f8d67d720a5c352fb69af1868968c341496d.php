    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?php echo Form::open(['url' => 'superadmin/updatebikesale', 'class' => 'form', 'id' => 'ccccc']); ?>
                ...
                <div class="input-group">
                    ...
                    <?php echo Form::select('admintype',CommonFx::Adminlist(),null, array('id'=>'admintype','class'=>'form-control','placeholder'=>'Select Adminmanager')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel\Laravel8\Bikebikroy\resources\views/admin/sale/bikesale.blade.php ENDPATH**/ ?>